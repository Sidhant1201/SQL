...
ALTER TABLE order_product_mapping
ADD FOREIGN KEY (product_id) REFERENCES product_info(product_id);
...
-- inserting values into branch_detials
...
-- iserting values into product_info table
...
-- INSERTING VALUES INTO order_product_mapping
...
( 1547, 141,  '2020-03-29',  8),( 1548, 132,  '2020-06-01',  7),( 1549, 150,  '2020-09-10',  4);
